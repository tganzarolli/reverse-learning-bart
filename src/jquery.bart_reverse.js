    ...
    $.fn.bart = function( method ) {
        ...
        var opts = {
            balloon: {                       // default settings for a balloon
                ...
                popprob:         2,        // probability of popping (as 1 out of X)
                ...
                onstart: function(s) {},      // function to run on new balloon
            ...
            showballooncount:  false,         // show number of balloons on board
            ...
            randomize:       false,           // randomize order of balloons, 
            // could be adapted if we need to randomize the order of the 2 steps
            ...
            var butInflate = $('<input>')
                ...
                .on('click.bart', function(e) {
                    ...
                    if(bal.popprob == bal.pumps) {
                        ...
                        butInflate.hide();
                        butCashin.hide();
                        var jump = opts.beforestart(opts, bal);
                        if (jump)
                            balcnt = jump;
